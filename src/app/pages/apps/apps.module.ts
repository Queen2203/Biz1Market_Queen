...
@NgModule({
  ...
  declarations: [...COMPONENTS, SaleComponent, SettingComponent, ReceiptComponent, CustomerComponent, AddproductComponent, StockEntryComponent, BatchEntryComponent, InternalTransferComponent, ProductsComponent, CategoryComponent, AddcategoryComponent, PurchaseEntryComponent, VendorsComponent, DispatchComponent, EditInternalOrderComponent, DispatchItemsComponent, ReceiveOrdComponent, EditreceiveComponent, CreditComponent, EditcreditComponent, CreditrepayComponent, PurchasemaintComponent, PurchasebillComponent, BillpaybyvendorComponent, MaintbilltypesComponent, AssetsComponent, AssettypesComponent, EditcreditrepayComponent, CreditdetailsComponent, EditcreditdetailsComponent, LocationComponent, BankaccountsComponent, BankaccountdetailComponent, BillbyvendorComponent],
})
